...
public abstract class RecipeMapCategoryJeiMixin {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, GTRecipeWrapper recipeWrapper,
        ...
        GregoriusDrugworksJeiRecipeWrapperAccess access =
                recipeWrapper instanceof GregoriusDrugworksJeiRecipeWrapperAccess ?
                        (GregoriusDrugworksJeiRecipeWrapperAccess) recipeWrapper : null;
        ...
        for (Widget uiWidget : modularUI.guiWidgets.values()) {
            ...
            } else if (uiWidget instanceof ChemicalPlantAtmosphereTankWidget) {
                ChemicalPlantAtmosphereTankWidget tankWidget = (ChemicalPlantAtmosphereTankWidget) uiWidget;
    ...
    private List<Integer> gdw$getSortedInputFluidSlots() {
        ...
        for (Widget uiWidget : modularUI.guiWidgets.values()) {
            if (!(uiWidget instanceof TankWidget) || uiWidget instanceof ChemicalPlantAtmosphereTankWidget) {
                continue;
            }
            TankWidget tankWidget = (TankWidget) uiWidget;
            if (importFluids.getFluidTanks().contains(tankWidget.fluidTank)) {
