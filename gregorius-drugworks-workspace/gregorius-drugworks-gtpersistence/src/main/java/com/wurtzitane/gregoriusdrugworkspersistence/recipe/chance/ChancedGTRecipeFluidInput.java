...
public class ChancedGTRecipeFluidInput extends GTRecipeFluidInput {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ChancedGTRecipeFluidInput)) {
            return false;
        }
        ChancedGTRecipeFluidInput other = (ChancedGTRecipeFluidInput) obj;
    ...
    public boolean equalIgnoreAmount(GTRecipeInput input) {
        ...
        ChancedGTRecipeFluidInput other = (ChancedGTRecipeFluidInput) input;
