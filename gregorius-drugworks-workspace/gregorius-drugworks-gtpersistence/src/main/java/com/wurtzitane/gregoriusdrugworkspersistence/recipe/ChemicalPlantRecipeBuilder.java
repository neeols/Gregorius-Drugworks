...
public class ChemicalPlantRecipeBuilder extends RecipeBuilder<ChemicalPlantRecipeBuilder> {
    ...
    @Override
    public boolean applyPropertyCT(@Nonnull String key, @Nonnull Object value) {
    ...
    public int getChemicalPlantTier() {
        return recipePropertyStorage == RecipePropertyStorage.EMPTY ? GTValues.MV :
                recipePropertyStorage.get(ChemicalPlantTierProperty.getInstance(), GTValues.MV);
    }

    public int getCoilTemperature() {
        return recipePropertyStorage == RecipePropertyStorage.EMPTY ? 0 :
                recipePropertyStorage.get(TemperatureProperty.getInstance(), 0);
    }

    public FluidStack getAtmosphere() {
        return recipePropertyStorage == RecipePropertyStorage.EMPTY ? null :
                recipePropertyStorage.get(ChemicalPlantAtmosphereProperty.getInstance(), null);
    }
